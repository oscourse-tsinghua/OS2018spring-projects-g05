...
\hline linkAddr\_o             & AddrWidth              & O     & id\_ex        & JAL和JALR指令的链接地址 \\
\hline valid\_i                & 1                      & I     & if\_id        & 高电平表示此指令不是空泡 \\
\hline valid\_o                & 1                      & O     & id\_ex        & 高电平表示此指令不是空泡 \\
\hline exceptCause\_i          & ExceptionCauseWidth    & I     & if\_id        & 截止译码阶段前发生的异常类型或无异常 \\
\hline exceptCause\_o          & ExceptionCauseWidth    & O     & id\_ex        & 截止译码阶段后发生的异常类型或无异常 \\
...
id实体的主要功能是译码，即根据指令各个比特的模式得出该指令的操作类型和操作数。
