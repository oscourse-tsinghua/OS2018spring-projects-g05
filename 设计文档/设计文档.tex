...
\hline InstWidth        & 0..31    & 指令宽度 \\
\hline DataWidth        & 0..31    & 数据宽度 \\
\hline AddrWidth        & 0..31    & 地址宽度 \\
\hline StallWidth       & 0..5     & 暂停信号宽度，每个分量对应一个需要被暂停的客体 \\
\hline 
\end{tabular*}  
\caption{常量}
\label{tb:constants}
...
\hline pcEnable\_o             & 1             & O     & if\_id        & 高电平 表示此指令不是空泡 \\
\hline 
\end{tabular*}  
