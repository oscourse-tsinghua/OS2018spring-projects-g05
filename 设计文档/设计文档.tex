...
\hline toWriteHi\_o            & DataWidth              & O     & ex\_mem       & 执行结果：写入HI寄存器的使能 \\
\hline toWriteLo\_o            & DataWidth              & O     & ex\_mem       & 执行结果：写入LO寄存器的使能 \\
...
\hline toWriteHi\_i            & DataWidth              & I     & ex            & 执行结果：写入HI寄存器的使能 \\
\hline toWriteLo\_i            & DataWidth              & I     & ex            & 执行结果：写入LO寄存器的使能 \\
\hline writeHiData\_i          & DataWidth              & I     & ex            & 执行结果：写入HI寄存器的值 \\
\hline writeLoData\_i          & DataWidth              & I     & ex            & 执行结果：写入LO寄存器的值 \\
\hline toWriteHi\_o            & DataWidth              & O     & mem           & 执行结果：写入HI寄存器的使能 \\
\hline toWriteLo\_o            & DataWidth              & O     & mem           & 执行结果：写入LO寄存器的使能 \\
