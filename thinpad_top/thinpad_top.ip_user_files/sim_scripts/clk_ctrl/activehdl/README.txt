...
#
# Generated by export_simulation on Wed Nov 22 18:32:00 +0800 2017
#
################################################################################
...
switch to the './clk_ctrl.sh' script.

./clk_ctrl.sh -reset_run
...
./clk_ctrl.sh -noclean_files

For more information on the script, please type './clk_ctrl.sh -help'.
