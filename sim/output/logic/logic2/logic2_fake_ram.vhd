...
architecture bhv of logic2_fake_ram is
...
words(5) <= x"25_28_43_00"; -- RUN or $5, $2, $3
words(6) <= x"26_28_a3_00"; -- RUN xor $5, $5, $3
words(7) <= x"27_38_43_00"; -- RUN nor $7, $2, $3
