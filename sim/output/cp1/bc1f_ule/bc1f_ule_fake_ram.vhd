...
use work.bc1f_ule_test_const.all;
use work.global_const.all;
use work.bus_const.all;

entity bc1f_ule_fake_ram is
    port (
        clk, rst: in std_logic;
        cpu_i: in BusC2D;
        cpu_o: out BusD2C
    );
end bc1f_ule_fake_ram;

architecture bhv of bc1f_ule_fake_ram is
...
words(6) <= x"00_18_83_44"; -- RUN mtc1 $3, $3
words(7) <= x"00_08_84_44"; -- RUN mtc1 $4, $1
words(8) <= x"00_00_85_44"; -- RUN mtc1 $5, $0
words(9) <= x"37_10_20_46"; -- RUN c.ule.d $f2, $f0
words(10) <= x"04_00_00_45"; -- RUN bc1f 0x10
