...
use work.cvt_d_test_const.all;
use work.global_const.all;
use work.bus_const.all;

entity cvt_d_fake_ram is
    port (
...
architecture bhv of cvt_d_fake_ram is
...
words(1) <= x"ff_7b_04_3c"; -- RUN lui $4, 0x7bff
words(2) <= x"ff_ff_84_34"; -- RUN ori $4, 0xffff
words(3) <= x"00_00_84_44"; -- RUN mtc1 $4, $0
words(4) <= x"a1_00_00_46"; -- RUN cvt.d.s $f2, $f0
words(5) <= x"00_10_06_44"; -- RUN mfc1 $6, $2
words(6) <= x"00_18_07_44"; -- RUN mfc1 $7, $3
