...
architecture bhv of cvt_d_tb is
...
begin
    ram_ist: entity work.cvt_d_fake_ram
        port map (
            clk => clk,
            rst => rst,
            cpu_i => ram_c2d,
...
process begin
    ...
    assert user_reg(7) = x"477fffff" severity FAILURE;
    wait;
end process;
process begin
    wait for CLK_PERIOD; -- resetting
    wait for 40 * CLK_PERIOD;
    assert user_reg(6) = x"e0000000" severity FAILURE;
    wait;
end process;
    end block assertBlk;
end bhv;
