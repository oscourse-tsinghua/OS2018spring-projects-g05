...
use work.bc1t_ge_test_const.all;
use work.global_const.all;
use work.bus_const.all;

entity bc1t_ge_fake_ram is
    port (
        clk, rst: in std_logic;
        cpu_i: in BusC2D;
        cpu_o: out BusD2C
    );
end bc1t_ge_fake_ram;

architecture bhv of bc1t_ge_fake_ram is
...
words(2) <= x"00_c0_04_3c"; -- RUN lui $4, 0xc000
words(3) <= x"00_10_83_44"; -- RUN mtc1 $3, $2
words(4) <= x"00_20_84_44"; -- RUN mtc1 $4, $4
words(5) <= x"35_10_24_46"; -- RUN c.ult.d $f2, $f4
...
words(13) <= x"37_10_24_46"; -- RUN c.ule.d $f2, $f4
words(14) <= x"04_00_01_45"; -- RUN bc1t 0x0010
words(15) <= x"00_00_00_00"; -- RUN nop
words(16) <= x"cc_cc_07_34"; -- RUN ori $7, $0, 0xcccc
