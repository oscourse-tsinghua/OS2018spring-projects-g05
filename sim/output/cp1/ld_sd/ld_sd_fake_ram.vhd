...
use work.ld_sd_test_const.all;
use work.global_const.all;
use work.bus_const.all;

entity ld_sd_fake_ram is
    port (
...
architecture bhv of ld_sd_fake_ram is
...
words(6) <= x"00_10_84_44"; -- RUN mtc1 $4, $2
words(7) <= x"00_18_86_44"; -- RUN mtc1 $6, $3
words(8) <= x"00_00_62_f4"; -- RUN sdc1 $2, 0($3)
