...
use work.multicore_boot1_test_const.all;
use work.global_const.all;
use work.bus_const.all;

entity multicore_boot1_fake_ram is
    port (
        clk, rst: in std_logic;
        cpu_i: in BusC2D;
        cpu_o: out BusD2C
    );
end multicore_boot1_fake_ram;

architecture bhv of multicore_boot1_fake_ram is
...
words(6) <= x"fc_03_88_37"; -- RUN ori $t0, $gp, 0x3fc
words(7) <= x"00_00_00_ad"; -- RUN sw $0, 0($t0)
words(8) <= x"00_00_09_8d"; -- RUN lw $t1, 0($t0)
words(9) <= x"fe_ff_20_11"; -- RUN beq $t1, $0, 0x20-0x28
words(10) <= x"00_00_00_00"; -- RUN nop
words(11) <= x"08_00_20_01"; -- RUN jr $t1
