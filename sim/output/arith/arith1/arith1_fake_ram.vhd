...
architecture bhv of arith1_fake_ram is
...
words(1) <= x"33_00_42_34"; -- RUN ori $2, $2, 0x33
words(2) <= x"20_18_43_70"; -- RUN clz $3, $2
words(3) <= x"21_18_43_70"; -- RUN clo $3, $2
