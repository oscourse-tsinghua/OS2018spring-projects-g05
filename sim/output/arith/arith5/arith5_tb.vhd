...
alias user_hi is <<signal ^.cpu1_ist.datapath_ist.hi_lo_ist.hiData: std_logic_vector(DataWidth)>>;
alias user_lo is <<signal ^.cpu1_ist.datapath_ist.hi_lo_ist.loData: std_logic_vector(DataWidth)>>;
-- CODE BELOW IS AUTOMATICALLY GENERATED
    begin
        -- CODE BELOW IS AUTOMATICALLY GENERATED
process begin
