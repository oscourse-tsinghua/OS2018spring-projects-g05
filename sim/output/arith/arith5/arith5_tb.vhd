...
alias user_hi is <<signal ^.cpu_ist.datapath_ist.hi_lo_ist.hiData: std_logic_vector(DataWidth)>>;
alias user_lo is <<signal ^.cpu_ist.datapath_ist.hi_lo_ist.loData: std_logic_vector(DataWidth)>>;
    begin
        -- CODE BELOW IS AUTOMATICALLY GENERATED
process begin
