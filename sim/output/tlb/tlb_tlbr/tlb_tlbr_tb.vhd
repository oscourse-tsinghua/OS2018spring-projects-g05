...
entity tlb_tlbr_tb is
end tlb_tlbr_tb;

architecture bhv of tlb_tlbr_tb is
...
process begin
    ...
    assert user_reg(7) = 32ux"01230000" severity FAILURE;
    wait;
end process;
process begin
    wait for CLK_PERIOD; -- resetting
    wait for 37 * CLK_PERIOD;
    assert user_reg(8) = 32ux"05670000" severity FAILURE;
    wait;
end process;
process begin
    wait for CLK_PERIOD; -- resetting
    wait for 38 * CLK_PERIOD;
    assert user_reg(9) = 32ux"09ab0000" severity FAILURE;
    wait;
end process;
    end block assertBlk;
end bhv;
