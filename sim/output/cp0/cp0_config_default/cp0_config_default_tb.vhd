...
entity cp0_config_default_tb is
end cp0_config_default_tb;

architecture bhv of cp0_config_default_tb is
...
process begin
    ...
    assert user_reg(2) = x"80000083" severity FAILURE;
    wait;
end process;
process begin
    wait for CLK_PERIOD; -- resetting
    wait for 10 * CLK_PERIOD;
    assert user_reg(3) = x"1e582c00" severity FAILURE;
    wait;
end process;
process begin
    wait for CLK_PERIOD; -- resetting
    wait for 11 * CLK_PERIOD;
    assert user_reg(4) = x"00018000" severity FAILURE;
    wait;
end process;
process begin
    wait for CLK_PERIOD; -- resetting
    wait for 12 * CLK_PERIOD;
    assert user_reg(5) = x"80000000" severity FAILURE;
    wait;
end process;
process begin
    wait for CLK_PERIOD; -- resetting
...
process begin
    ...
    assert user_reg(7) = x"00000000" severity FAILURE;
    wait;
end process;
    end block assertBlk;
end bhv;
