...
architecture bhv of sync3_tb is
...
begin
    ram_ist: entity work.sync3_fake_ram
        port map (
            clk => clk,
            rst => rst,
            cpu_i => ram_c2d,
...
process begin
    ...
    assert user_reg(10) = 32ux"1" severity FAILURE;
    wait;
end process;
process begin
    wait for CLK_PERIOD; -- resetting
    wait for 500 * CLK_PERIOD;
    assert user_reg(11) = 32ux"0" severity FAILURE;
    wait;
end process;
process begin
    wait for CLK_PERIOD; -- resetting
    wait for 500 * CLK_PERIOD;
    assert user_reg(2) = 32ux"1234" severity FAILURE;
    wait;
end process;
process begin
    wait for CLK_PERIOD; -- resetting
    wait for 500 * CLK_PERIOD;
    assert user_reg(3) = 32ux"0" severity FAILURE;
    wait;
end process;
    end block assertBlk;
end bhv;
