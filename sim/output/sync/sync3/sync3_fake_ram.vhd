...
use work.sync3_test_const.all;
use work.global_const.all;
use work.bus_const.all;

entity sync3_fake_ram is
    port (
...
architecture bhv of sync3_fake_ram is
...
words(2) <= x"00_01_80_af"; -- RUN sw $0, 0x100($gp)
words(3) <= x"04_01_80_af"; -- RUN sw $0, 0x104($gp)
words(4) <= x"34_12_0a_34"; -- RUN ori $t2, $0, 0x1234
words(5) <= x"00_01_89_c3"; -- RUN ll $t1, 0x100($gp)
words(6) <= x"00_01_8a_e3"; -- RUN sc $t2, 0x100($gp)
words(7) <= x"34_12_0b_34"; -- RUN ori $t3, $0, 0x1234
words(8) <= x"04_01_89_c3"; -- RUN ll $t1, 0x104($gp)
words(9) <= x"04_01_89_8f"; -- RUN lw $t1, 0x104($gp)
words(10) <= x"04_01_8b_e3"; -- RUN sc $t3, 0x104($gp)
words(11) <= x"00_01_82_8f"; -- RUN lw $v0, 0x100($gp)
words(12) <= x"04_01_83_8f"; -- RUN lw $v1, 0x104($gp)
