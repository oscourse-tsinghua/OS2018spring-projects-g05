...
architecture bhv of sync4_fake_ram is
...
words(2) <= x"00_01_88_c3"; -- RUN ll $t0, 0x100($gp)
words(3) <= x"34_12_08_34"; -- RUN ori $t0, $0, 0x1234
words(4) <= x"00_01_88_e3"; -- RUN sc $t0, 0x100($gp)
words(5) <= x"fc_ff_00_11"; -- RUN beq $t0, $0, 0x08-0x18
words(6) <= x"00_00_00_00"; -- RUN nop
words(7) <= x"00_01_89_8f"; -- RUN lw $t1, 0x100($gp)
