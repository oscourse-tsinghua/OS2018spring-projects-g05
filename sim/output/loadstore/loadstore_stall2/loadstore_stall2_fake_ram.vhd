...
use work.loadstore_stall2_test_const.all;
use work.global_const.all;
use work.bus_const.all;

entity loadstore_stall2_fake_ram is
    port (
        clk, rst: in std_logic;
        cpu_io: inout BusInterface
    );
end loadstore_stall2_fake_ram;

architecture bhv of loadstore_stall2_fake_ram is
...
words(2) <= x"00_80_02_3c"; -- RUN lui $2, 0x8000
words(3) <= x"24_00_42_34"; -- RUN ori $2, $2, 0x0024
words(4) <= x"00_01_42_ad"; -- RUN sw $2, 0x100($10)
words(5) <= x"00_01_43_8d"; -- RUN lw $3, 0x100($10)
words(6) <= x"09_f8_60_00"; -- RUN jalr $3
words(7) <= x"00_00_00_00"; -- RUN nop
words(8) <= x"34_12_04_3c"; -- RUN lui $4, 0x1234
words(9) <= x"67_45_84_34"; -- RUN ori $4, $4, 0x4567
