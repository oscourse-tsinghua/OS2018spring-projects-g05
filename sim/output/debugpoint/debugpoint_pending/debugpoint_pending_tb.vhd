...
end debugpoint_pending_tb;

architecture bhv of debugpoint_pending_tb is
...
process begin
    ...
    assert user_reg(5) = 32ux"0100" severity FAILURE;
    wait;
end process;
process begin
    wait for CLK_PERIOD; -- resetting
...
process begin
    wait for CLK_PERIOD; -- resetting
    wait for 50 * CLK_PERIOD;
    assert user_reg(6) = 32ux"0001" severity FAILURE;
    wait;
end process;
    end block assertBlk;
end bhv;
