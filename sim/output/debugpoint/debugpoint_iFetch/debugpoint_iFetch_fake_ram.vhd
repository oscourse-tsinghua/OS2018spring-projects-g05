...
use work.debugpoint_iFetch_test_const.all;
use work.global_const.all;
use work.bus_const.all;

entity debugpoint_iFetch_fake_ram is
    port (
        clk, rst: in std_logic;
        cpu_io: inout BusInterface
    );
end debugpoint_iFetch_fake_ram;

architecture bhv of debugpoint_iFetch_fake_ram is
...
words(2) <= x"2c_00_42_34"; -- RUN ori $2, $2, 0x002c
