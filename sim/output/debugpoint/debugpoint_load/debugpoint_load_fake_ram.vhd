...
entity debugpoint_load_fake_ram is
    port (
...
end debugpoint_load_fake_ram;

architecture bhv of debugpoint_load_fake_ram is
...
words(2) <= x"62_00_42_34"; -- RUN ori $2, $2, 0x0062
words(3) <= x"00_90_82_40"; -- RUN mtc0 $2, $18
words(4) <= x"00_60_80_40"; -- RUN mtc0 $0, $12
words(5) <= x"00_00_00_00"; -- RUN nop
words(6) <= x"02_00_44_38"; -- RUN xori $4, $2, 0x0002
words(7) <= x"00_00_85_8c"; -- RUN lw $5, 0($4)
