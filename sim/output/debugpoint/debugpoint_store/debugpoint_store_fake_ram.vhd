...
use work.debugpoint_store_test_const.all;
use work.global_const.all;

entity debugpoint_store_fake_ram is
    port (
...
end debugpoint_store_fake_ram;

architecture bhv of debugpoint_store_fake_ram is
...
words(2) <= x"61_00_42_34"; -- RUN ori $2, $2, 0x0061
words(3) <= x"00_90_82_40"; -- RUN mtc0 $2, $18
words(4) <= x"00_00_00_00"; -- RUN nop
words(5) <= x"00_00_00_00"; -- RUN nop
words(6) <= x"01_00_44_38"; -- RUN xori $4, $2, 0x0001
words(7) <= x"00_00_85_ac"; -- RUN sw $5, 0($4)
...
words(17) <= x"11_00_00_08"; -- RUN j 0x44
