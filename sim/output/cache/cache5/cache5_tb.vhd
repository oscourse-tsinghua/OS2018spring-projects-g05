...
architecture bhv of cache5_tb is
...
begin
    ram_ist: entity work.cache5_fake_ram
        port map (
            clk => clk,
            rst => rst,
            enable_i => devEnable,
...
process begin
    ...
    assert user_reg(2) = 32x"0000ffe8" severity FAILURE;
    wait;
end process;
process begin
    wait for CLK_PERIOD; -- resetting
    wait for 9 * CLK_PERIOD;
    assert user_reg(3) = 32x"00003c03" severity FAILURE;
    wait;
end process;
    end block assertBlk;
end bhv;
