...
use work.cache5_test_const.all;
use work.global_const.all;

entity cache5_fake_ram is
    port (
...
architecture bhv of cache5_fake_ram is
...
words(2) <= x"20_00_44_8d"; -- RUN lw $4, 0x20($10)
words(3) <= x"24_00_42_95"; -- RUN lhu $2, 0x24($10)
words(4) <= x"26_00_43_95"; -- RUN lhu $3, 0x26($10)
words(5) <= x"00_00_00_00"; -- RUN nop
words(6) <= x"00_00_00_00"; -- RUN nop
words(7) <= x"00_00_00_00"; -- RUN nop
words(8) <= x"00_00_00_00"; -- RUN nop
words(9) <= x"e8_ff_03_3c"; -- RUN lui $3, 0xffe8
