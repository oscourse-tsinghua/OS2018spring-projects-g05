...
use work.cache2_test_const.all;
...
architecture bhv of cache2_tb is
...
begin
    ram_ist: entity work.cache2_fake_ram
        port map (
            clk => clk,
            rst => rst,
            enable_i => devEnable,
...
process begin
    ...
    assert user_reg(8) = 32x"00000001" severity FAILURE;
    wait;
end process;
process begin
    wait for CLK_PERIOD; -- resetting
...
process begin
    ...
    assert user_reg(8) = 32x"00000002" severity FAILURE;
    wait;
end process;
    end block assertBlk;
end bhv;
