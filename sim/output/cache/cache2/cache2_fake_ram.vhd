...
architecture bhv of cache2_fake_ram is
...
words(5) <= x"00_01_42_ad"; -- RUN sw $2, 0x100($10)
words(6) <= x"00_00_00_00"; -- RUN nop
words(7) <= x"00_00_00_00"; -- RUN nop
words(8) <= x"01_00_08_21"; -- RUN addi $8, $8, 1
words(9) <= x"05_00_00_08"; -- RUN j 0x14
