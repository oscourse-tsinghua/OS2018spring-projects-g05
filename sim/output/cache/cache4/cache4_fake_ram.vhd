...
architecture bhv of cache4_fake_ram is
...
words(2) <= x"12_00_02_24"; -- RUN li $2, 0x12
words(3) <= x"34_00_03_24"; -- RUN li $3, 0x34
words(4) <= x"00_01_42_a1"; -- RUN sb $2, 0x100($10)
words(5) <= x"01_01_43_a1"; -- RUN sb $3, 0x101($10)
words(6) <= x"00_01_44_85"; -- RUN lh $4, 0x100($10)
